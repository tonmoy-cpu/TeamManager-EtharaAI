...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-fuchsia-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to continue to Team Task Manager</p>
        </div>
